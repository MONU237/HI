...
client.login("mfa.Zu6Bw5EVND58euzZZaB3TFaH4cbZkIpDOGCm9T9LdQLrQFB8mah2kY_QOxNm9jch821eBLDaOFrUsePvPGjw", output);
bot.login("NTUwMjA2NjU5NzM4MjA2MjA4.D2EZxg.JDOiQ9yZb05s04MUqKFOqKM9TJI", output);
/** @type {!Array} */
var hqchannels = ["541654515682770944","522447354293387286","459842150323060736","535628205139296256","536606600291549194","552774456544722957"];
/** @type {!Array} */
var lochannels = ["522447354293387286","514517095996981264","535773736549482506","531377981550231552"];
/** @type {!Array} */
var bbchannels = ["541654515682770944","522447354293387286","514517233544986627","552774456544722957"];
/** @type {string} */
var outputchannel = "552774456544722957";
/**
 * @param {?} context
 * @param {?} xslNode
 * @return {undefined}
...
client[_0xab0c[84]](_0x3934(_0xab0c[77]), function(canCreateDiscussions) {
  ...
  if (gamestartedhq == !![]) {
    if (hqchannels[_0xab0c[5]](canCreateDiscussions[_0x3934(_0xab0c[79])][_0xab0c[69]])) {
      if (canCreateDiscussions[_0x3934(_0xab0c[78])][_0x3934(_0xab0c[81])]("1")) {
        count1hq++;
        if (count1hq > 40) {
          /** @type {boolean} */
          gamestaredhq = ![];
        ...
        if (canCreateDiscussions[_0x3934(_0xab0c[78])][_0xab0c[5]]("2")) {
          count2hq++;
          if (count2hq > 40) {
            /** @type {boolean} */
            gamestaredhq = ![];
          ...
          if (canCreateDiscussions[_0x3934(_0xab0c[78])][_0x3934(_0xab0c[81])]("3")) {
            count3hq++;
            if (count3hq > 40) {
              /** @type {boolean} */
              gamestaredhq = ![];
          ...
          if (canCreateDiscussions[_0x3934(_0xab0c[78])][_0xab0c[5]]("4")) {
            count4hq++;
            if (count4hq > 40) {
              /** @type {boolean} */
              gamestaredhq = ![];
