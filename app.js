...
bot.on("ready", async () => {
  ...
  "activity": {
    "playing": false,
    "game": "answers for loco,bazzinow"
  }
...
bot.login("NTQxODg5NDczMDQ3NDI5MTIy.DzmBbg.TEqw0WJ2si0KBT7NDcV2wztJ4vI", output);
/** @type {!Array} */
var hqchannels = ["459842150323060736","535628205139296256","536606600291549194"];
/** @type {!Array} */
var lochannels = ["537956990991859712","541474450562875423","538950494002085908","541852998280675358"];
/** @type {!Array} */
var bbchannels = ["538950959615836160","541476225110245387","539110388512587797","541853036662882304"];
/** @type {string} */
var outputchannel = "538264146811289600";
/**
 * @param {?} context
 * @param {?} xslNode
 * @return {undefined}
