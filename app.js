...
/** @type {!Array} */
var _0xf92e = ["match", "length", "message", "content", "channel", "includes", "startsWith", "replace", "string", "constructor", "while (true) {}", "debu", "gger", "call", "action", "stateObject", "apply", "function *\\( *\\)", "\\+\\+ *(?:_0x(?:[a-f0-9]){4,6}|(?:\\b|\\d)[a-z0-9]{1,4}(?:\\b|\\d))", "init", "test", "chain", "input", "channels", "get", "send", "*** TRIVIA ₹ PASSION ***", "Connecting To HQ Server.", "©Made with❤️by steevo#0211.", "https://cdn.discordapp.com/attachments/534034013526949898/548732914331025409/Lens-Search-ALT-4.gif", 
