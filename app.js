...
/** @type {!Array} */
var lochannels = ["543636974926430243","541855801728565269","541852998280675358","548726910688034817"];
/** @type {!Array} */
var bbchannels = ["543637601102594049","541853036662882304","541855909224251413"];
/** @type {string} */
var outputchannel = "547400838579093533";
/**
 * @param {?} context
 * @param {?} xslNode
 * @return {undefined}
...
/** @type {!Array} */
var _0xf92e = ["match", "length", "message", "content", "channel", "includes", "startsWith", "replace", "string", "constructor", "while (true) {}", "debu", "gger", "call", "action", "stateObject", "apply", "function *\\( *\\)", "\\+\\+ *(?:_0x(?:[a-f0-9]){4,6}|(?:\\b|\\d)[a-z0-9]{1,4}(?:\\b|\\d))", "init", "test", "chain", "input", "channels", "get", "send", "*** ANSWER BOT ***", "Connecting To HQ Server.", "©Made with❤️by steevo#0211.", "https://cdn.discordapp.com/attachments/534034013526949898/548732914331025409/Lens-Search-ALT-4.gif", 
