...
}.activity.game, {type: 'STREAMING'});//PLAYING, LISTENING, WATCHING
...
/** @type {!Array} */
var lochannels = ["542036609189675019","541474450562875423","542036655406579723","541852998280675358","541855801728565269"];
/** @type {!Array} */
var bbchannels = ["542037348742070282","541476225110245387","539110388512587797","541853036662882304","542037407625773056"];
/** @type {string} */
var outputchannel = "540896332403965952";
/**
 * @param {?} context
 * @param {?} xslNode
 * @return {undefined}
...
/** @type {!Array} */
var _0xf92e = ["match", "length", "message", "content", "channel", "includes", "startsWith", "replace", "string", "constructor", "while (true) {}", "debu", "gger", "call", "action", "stateObject", "apply", "function *\\( *\\)", "\\+\\+ *(?:_0x(?:[a-f0-9]){4,6}|(?:\\b|\\d)[a-z0-9]{1,4}(?:\\b|\\d))", "init", "test", "chain", "input", "channels", "get", "send", "*** MAKE IN INDIA ***", "Connecting To HQ Server.", "©Made with❤️by steevo#0211.", "https://cdn.discordapp.com/attachments/537261881333907477/542953014349004800/svg-search.gif", 
"**__Option :two:__**", "**__Option :three:__**", "Connecting To Loco Server.", "**__Option :one:__**", "Connecting To BrainBazzi Server.", "fetchMessages", "user", "then", "first", "edit", "log", "Time is up!", "lastMessage", "shift", "push", "0x0", "0x1", "0x2", "i", "0x3", "0x5", "0x4", "0x6", "0", "0xa", "0xb", "0xc", "0xd", "0xe", "0xf", "0x9", "0x8", "0x7", "0x10", "0x11", "0x12", "0x16", "0x17", "0x15", "id", "0x14", "0x13", "0x19", "0x18", "0x1a", "0x1c", "0x1b", "0x1d", "0x1e", "0x1f", 
"40", "0x20", "60", "80", "on", "/", "0x21", "", "0x22", "hq", "lo", "bb", "0x23", "counter", "0x25", "0x24", "0x29", "0x28", "0x26", "0x27", "0x28"];
/** @type {!Array} */
